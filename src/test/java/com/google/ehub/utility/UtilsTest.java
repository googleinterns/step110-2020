...
public final class UtilsTest {
  ...
  public void getTimestampMillisFromDateWithValidParams_ReturnsCorrectTimestamp() {
    Assert.assertEquals(CORRECT_TIMESTAMP, Utils.getTimestampMillisFromDate(VALID_DATE, DATE_FORMAT));
  }

  @Test
  public void getTimestampMillisFromDateWithConflictingFormat_ReturnsNull() {
    Assert.assertEquals(null, Utils.getTimestampMillisFromDate(DATE_WITH_CONFLICTING_FORMAT, DATE_FORMAT));
  }
  ...
  public void getDateFromTimestampMillisWithValidParams_ReturnsCorrectDate() {
    Assert.assertEquals(VALID_DATE, Utils.getDateFromTimestampMillis(CORRECT_TIMESTAMP, DATE_FORMAT));
  }

  @Test
  public void getDateFromTimestampMillisWithInvalidFormat_ReturnsNull() {
    Assert.assertEquals(null, Utils.getDateFromTimestampMillis(CORRECT_TIMESTAMP, INVALID_DATE_FORMAT));
  }
}
